...
#define INSTPAT_MATCH(s, name, type, ... /* execute body */ ) { \
  ...
  INSTPAT("0011000 00010 00000 000 00000 1110011", mret , R, s->dnpc = cpu.csr[CSR_MEPC]);
  ...
  INSTPAT("000000000000 00000 000 00000 1110011", ecall, I, printf("MPP: %d\n", (cpu.csr[CSR_MSTATUS]>>11)&3); s->dnpc = isa_raise_intr(0xb, s->pc));
